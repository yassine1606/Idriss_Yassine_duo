...
export const Adil = ({ choix, change, choixNb, choixTmp, tmp, active4, total }) => {
  return (
    ...
    <div className={`${active4} h-full`}>
      ...
      <div className='flex justify-between px-3 mt-2 py-2'>
        <p className='text-gray-500 text-sm'>Total (per${choixTmp})</p>
        <p className='font-bold text-violet-700'>${total}{tmp}</p>
      </div>
